...
static autoc4_output_config outputs[] = {
  { PORT_INDEX_A, 4, string_output_1, false, false },
  { PORT_INDEX_A, 5, string_output_2, false, false },
  { PORT_INDEX_A, 6, string_output_3, false, false },
  { PORT_INDEX_A, 7, string_output_4, false, false },
};
static autoc4_input_config inputs[] = {
  { PORT_INDEX_D, 2, string_input_1, false, false },
  { PORT_INDEX_D, 3, string_input_2, true,  false },
  { PORT_INDEX_D, 4, string_input_3, true,  false },
  { PORT_INDEX_D, 5, string_input_4, true,  false },
  { PORT_INDEX_D, 6, string_input_5, true,  false },
};
